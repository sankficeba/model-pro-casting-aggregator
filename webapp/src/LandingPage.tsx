      ...
      <section style={{ background: WHITE, paddingTop: 64, minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden" }}>
        <div style={{ padding: "80px 5vw 0", position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{
            ...
            model<br />
            <span style={{ paddingLeft: "14vw" }}>pro</span><br />
            <span style={{ paddingLeft: "7vw", fontStyle: "italic", fontWeight: 400 }}>agency</span>
          </h1>
          ...
          <div className="lp-hero-sub" style={{
            ...
            <div style={{ maxWidth: 300 }}>
              <p style={{ fontSize: 15, lineHeight: 1.75, color: "rgba(0,0,0,.45)", fontFamily: SANS }}>
                Агрегатор кастингов<br />200+ Telegram-каналов
              </p>
            ...
            <div className="lp-hero-sub-right" style={{ textAlign: "right" }}>
              ...
              <a href={BOT_URL} target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 16, fontSize: 12, letterSpacing: 1, color: GOLD, textDecoration: "none", fontFamily: SANS }}>
                шоурил ›
              </a>
            </div>
          </div>
        ...
        {/* Warm gradient blob — like aroundbrand's bottom orange blob */}
        <div style={{
          marginTop: 64, height: 280, position: "relative", overflow: "hidden",
          animation: "fadeUp 1s .5s ease both",
        }}>
          <div style={{
            position: "absolute",
            inset: "-40px -10% -40px",
            background: GRAD_WARM,
            filter: "blur(64px)",
            opacity: 0.65,
          ...
          <div style={{
            ...
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 40L40 0' stroke='rgba(0,0,0,.05)' stroke-width='.5'/%3E%3C/svg%3E")`,
          }} />
          {/* stats over blob */}
          <div style={{
            position: "absolute", inset: 0,
            display: "flex", alignItems: "center", justifyContent: "center", gap: "8vw",
          }}>
            {[["200+", "каналов"], ["4", "направления"], ["24/7", "мониторинг"]].map(([n, l]) => (
              <div key={l} style={{ textAlign: "center" }}>
                <div style={{ fontFamily: SERIF, fontWeight: 900, fontSize: "clamp(32px, 5vw, 64px)", color: WHITE, lineHeight: 1 }}>{n}</div>
                <div style={{ fontSize: 10, letterSpacing: 3, textTransform: "uppercase", color: "rgba(255,255,255,.55)", marginTop: 10, fontFamily: SANS }}>{l}</div>
              </div>
            ))}
          </div>
        </div>
