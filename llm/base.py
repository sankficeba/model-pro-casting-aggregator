  ...
  "vacancies": [                         // список ролей; пустой если is_casting=false
    {
      ...
      "gender": "male"|"female"|null,    // кого ищут на эту роль.
                                         // Явные маркеры: «парень», «мужчина»,
                                         // «м.», «male» → male; «девушка»,
                                         // «женщина», «ж.», «female» → female.
                                         // КОНТЕКСТНЫЕ маркеры: если пол не
                                         // назван прямо, но из описания
                                         // ОДНОЗНАЧНО следует пол модели —
                                         // ставь его. Например, гардероб
                                         // только женский (платье, юбка,
                                         // корсет, шуба, каблуки, чулки,
                                         // вечернее платье) → female; только
                                         // мужской (галстук, бабочка, костюм-
                                         // тройка, борода обязательна) → male.
                                         // Если контекст неоднозначен или
                                         // нейтрален — оставь null.
