  ...
  "vacancies": [                         // список ролей; пустой если is_casting=false
    {
      ...
      "gender": "male"|"female"|null,    // кого ищут на эту роль.
                                         ...
                                         //   женские формы названия роли
                                         //   («танцовщица», «актриса»,
                                         //   «ведущая», «фотомодель»,
                                         //   «промо-модель») → female.
                                         //   Мужские формы: «актёр»,
                                         //   «ведущий», «танцор» (без «-щица»)
                                         //   → male.
      ...
      "age_max": int|null,                // верхний возраст
                                         ...
                                         // Примеры:
                                         //   «45-50 лет» → age_min=45, age_max=50
                                         //   «18 - 25»   → age_min=18, age_max=25
                                         //   «25 лет»    → age_min=25, age_max=25
                                         //   «от 30»     → age_min=30, age_max=null
                                         //   «до 40»     → age_min=null, age_max=40
                                         //   «25-30 лет, 35-40 лет» (две роли) →
                                         //   две разные vacancies с своими
                                         //   age_min/max, не диапазон 25-40.
                                         // Без чисел — оба null. Не оставляй
                                         // null если возраст явно указан.
