...
GLOBAL_BLACKLIST_SUBSTRINGS = (
    # SVO в любых формах
    "сво",                       # «НЕ СВО», «на СВО»
    "спецоперация",              # эвфемизм
    # Контрактная / военная служба
    "служба по контракту",
    "военная служба",
    "военнослужащий",
    "военнослуж",                 # любые производные
    "контрактник",
    "контрактная служба",
    # Подразделения / структуры
    "вс рф",
    "вооружённые силы",
    "вооруженные силы",
    "войсковая часть",
    ...
    "оператор бпла",
    "бпла",
    # Африканский корпус, Рубикон и т.д.
    "африканский корпус",
    # Добровольцы / мобилизация
    "доброволец",
    "мобилизация",
    # Военный гонорар / ЕДВ
    "едв",
